 ...
 */
public class CrashHandlerUtils extends Exception implements Thread.UncaughtExceptionHandler {
...
//                Toast.makeText(mContext, "很抱歉,程序出现异常,即将退出.", Toast.LENGTH_LONG).show();
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "CrashLog" + time + timestamp + ".txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = StaticConstants.CACHE_PATHE + "Log/" + time + "/";
