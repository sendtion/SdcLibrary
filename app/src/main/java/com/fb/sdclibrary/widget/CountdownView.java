...
public class CountdownView extends View {
    ...
    public CountdownView(Context context, AttributeSet attrs, int defStyle) {
        ...
        arcColor = ta.getColor(R.styleable.CountdownView_arcColor, ARC_COLOR);
        numColor = ta.getColor(R.styleable.CountdownView_numColor, NUM_COLOR);
        arcStrokeWidth = ta.getDimension(R.styleable.CountdownView_arcStrokeWidth,
                dp2px(ARC_STROKE_WIDTH_IN_DP));
        numTextSize = ta.getDimension(R.styleable.CountdownView_numTextSize,
                sp2px(NUM_TEXT_SIZE_IN_SP));
        radius = ta.getDimension(R.styleable.CountdownView_mRadius, dp2px(RADIUS_IN_DP));
        initDegree = ta.getInt(R.styleable.CountdownView_initDegree, INIT_DEGREE);
        maxNum = maxNumForText = ta.getInt(R.styleable.CountdownView_maxNum, MAX_NUM);
        isCW = ta.getBoolean(R.styleable.CountdownView_isCW, IS_CW);
        plusNumAnimDuration = ta.getFloat(R.styleable.CountdownView_plusNumAnimDuration,
