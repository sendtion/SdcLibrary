...
public class DashLineView extends View {
    ...
    public static final int DEFAULT_LINE_COLOR = 0xE7E7E7;
    ...
    public DashLineView(Context context, AttributeSet attrs) {
        ...
        lineWidth = typedArray.getDimension(R.styleable.DashLineView_lineSize, DEFAULT_LINE_WIDTH);
        lineColor = typedArray.getColor(R.styleable.DashLineView_lineColor, DEFAULT_LINE_COLOR);
