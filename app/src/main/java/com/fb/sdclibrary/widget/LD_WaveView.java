...
import com.fb.sdclibrary.widget.entry.Point;
...
public class LD_WaveView extends View {
    ...
    private int mBorderColor;//边框色
    private int mOutColor;//院外颜色
    ...
    private void init() {
        ...
        mTextPaint.setTextSize(getResources().getDimension(R.dimen.x48));


        //圆环画笔
        mCirclePaint = new Paint();
        mCirclePaint.setAntiAlias(true);
        mCirclePaint.setColor(mOutColor);
        mCirclePaint.setStyle(Paint.Style.STROKE);
        //边界线画笔
        mBorderPaint = new Paint();
        mBorderPaint.setAntiAlias(true);
        mBorderPaint.setColor(mBorderColor);//30cccccc
        mBorderPaint.setStrokeWidth(mBorderWidth);
        mBorderPaint.setStyle(Paint.Style.STROKE);

        mCircleFillPaint = new Paint();
        mCircleFillPaint.setStrokeWidth(5);
    ...
    private void getAttr(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFillColor = a.getColor(R.styleable.LD_WaveView_wave_circle_fill_color, Color.WHITE);
        mBorderColor = a.getColor(R.styleable.LD_WaveView_wave_circle_border_color, Color.WHITE);
        mOutColor = a.getColor(R.styleable.LD_WaveView_wave_out_circle_color, Color.WHITE);
        mTextColor = a.getColor(R.styleable.LD_WaveView_wave_progress_text_color, Color.BLACK);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isCircle) {
            ...
            canvas.drawCircle(mViewWidth / 2, mViewHeight / 2, mViewHeight / 2, mCircleFillPaint);
        }
        /**
         * 绘制线条
         */
...
//            mTextPaint.setColor(getResources().getColor(R.color.color_3));
//        else
//            mTextPaint.setColor(getResources().getColor(R.color.color_3));
